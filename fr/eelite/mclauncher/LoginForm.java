...
public class LoginForm extends TransparentPanel
{
  ...
  private TransparentButton retryButton = new TransparentButton("R\u00E9essayer");
  ...
  private JPanel buildLoginPanel() {
    ...
    if (Config.getProperty("offline").equals("false")) {
  ...
  private TransparentPanel buildOfflinePanel()
  {
    ...
    if ((!canPlayOffline) && 
      (Config.getProperty("canplayoffline").equals("true")))
    {
